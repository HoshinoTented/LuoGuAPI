...
open class ProblemListPage(val pageCount: Int, val filter: ProblemSearchConfig, override val client: HttpClient) : AbstractLuoGuPage() {
	private val listClass = "lg-content-table-left"

	override val url: String get() = "${LuoGuUtils.baseUrl}/problemnew/lists?$filter&page=$pageCount"
